...
const style = {
  wrapper: `h-full text-[#CCD6F6] select-none h-full w-screen flex-1 pt-14 flex items-end justify-end pb-12 overflow-scroll px-8`,
  txHistoryItem: `bg-[#112240] rounded-lg px-4 py-2 my-2 flex items-center justify-end`,
  txDetails: `flex items-center`,
  toAddress: `text-[#FCA311] mx-2`,
  txTimestamp: `mx-2`,
  etherscanLink: `flex items-center text-[#64FFDA]`,
}
